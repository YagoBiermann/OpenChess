...
namespace OpenChess.Tests
{
    ...
    {
        public static MatchInfo RestoreMatch(string fen, string mId, string p1Id, string p2Id, long p1TimeRemaining, long p2TimeRemaining, string currentTurnStartedAt, int mtime = 5, string status = "100", char? winner = null)
        {
            string matchId = mId;
        ...
        public static Match RestoreMatch(string fen, string status = "100")
        {
        ...
        public static Match RestoreAndPlay(string fen, string origin, string destination, string? promoting = null, int time = 5, string status = "100")
        {
            string matchId = Guid.NewGuid().ToString();
            ...
            List<PlayerInfo> players = [player1, player2];
            string currentTurnStartedAt = DateTime.UtcNow.ToString();
            MatchInfo matchInfo = new(matchId, players, fen, [], status, time, currentTurnStartedAt, DateTime.UtcNow.ToString());
            Match match = new(matchInfo);
