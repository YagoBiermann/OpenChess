...
namespace OpenChess.Tests
{
    ...
    public class DefaultMoveTests
    {
        ...
        [TestMethod]
        public void Play_ShouldBeAbleToCaptureEnemyPiece(string fen, string position1, string position2, char moved, char captured)
        {
        ...
        [TestMethod]
        public void Play_ShouldNotBeAbleToCaptureAllyPiece(string fen, string position1, string position2)
        {
            Chessboard chessboard = new(new FenInfo(fen));
            Coordinate origin = Coordinate.GetInstance(position1);
            Coordinate destination = Coordinate.GetInstance(position2);
        ...
        [TestMethod]
        public void Play_OriginWithEmptySquare_ShouldThrowException()
        {
        ...
        [TestMethod]
        public void Play_GivenOriginAndDestinationWithEmptySquare_ShouldChangePiecePosition()
        {
            Chessboard chessboard = new(new FenInfo("7k/1R6/7K/8/8/1b6/8/8 w - - 0 1"));
